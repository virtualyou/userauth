...
const sequelize = new sequelize_typescript_1.Sequelize(
  config_1.default.database.db,
  config_1.default.database.user,
  config_1.default.database.password,
  {
    logging: false,
...
db.role = (0, role_model_1.default)(
  sequelize,
  sequelize_typescript_1.Sequelize
);
db.user = (0, user_model_1.default)(
  sequelize,
  sequelize_typescript_1.Sequelize
);
